...
var fight = function(enemyName) {
  ...
  while(enemyHealth > 0 && enemyHealth > 0) {
      ...
      console.log("enemyHealth was " + enemyHealth);
      console.log("Damage is " + damage);
      enemyHealth = Math.max(0, enemyHealth - damage);
      console.log("enemyHealth is now " + enemyHealth);
      ...
      console.log("playerHealth was " + playerHealth);
      playerHealth = Math.max(0, playerHealth - damage);
      console.log("damage is " + damage);
      console.log("playerHealth is now " + playerHealth);
      console.log(
...
var startGame = function() {
  ...
  for (var i = 0; i < enemyNames.length; i++) {
    ...
    if (playerHealth > 0) {
      ...
      // window.alert("enemyhealth = " + enemyHealth)
