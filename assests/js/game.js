...
var startGame = function() {
  ...
  for (var i = 0; i < enemyInfo.length; i++) {
    ...
    if (playerInfo.health > 0) {
      ...
      // pick enw enemy ot fight based on the index of the enemy.names array
      var pickedEnemyObj = enemyInfo[i];

      // reset enemy.health before starting new fight
      pickedEnemyObj.health = randomNumber(40, 60);
      // window.alert("enemy.health = " + enemy.health)

      // pass the pickedenemy.name variable's value into the fight function, where it will assume he value of the enemy.name parameter
